...
| K สำนวนแปล (ทำการ/มีการ/ดังนี้) · รอ งาน 2 | ✓ | ✓ | ⇄ เป็น convention คนเขียนเติมเอง | ± | ± แกนที่ขยับจริงคือ register-lift ไม่ใช่ translationese (ดู 8d) |
| L ตารางคำ AI · รอ งาน 2 | ✓ | ✓ | ✓ | ✓ | – ยังไม่ทดสอบ (base rate ต่ำมาก ดู 8g) |

...
| N อักขรวิธีไทย · TH-OR-01…04 | ✓ hard เฉพาะ TH-OR-01/02 · TH-OR-03 (หน่วยวัดในจอ) กับ TH-OR-04 (`"` คร่อม string) ปิด | ± เนื้อหา/บทความที่ ship = ✓ · docs/commit ของเจ้าของ = ✗ | ✓ | ✓ | ✓ hard |

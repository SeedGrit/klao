...
| N อักขรวิธีไทย (งาน 8e) | ✓ hard (ยกเว้น N3 หน่วยวัด) | ± เนื้อหา/บทความที่ ship = ✓ · docs/commit ของเจ้าของ = ✗ | ✓ | ✓ | ✓ hard |
...
### 8e. หมวดใหม่ N — อักขรวิธีไทย (`hard` ในของที่ ship ให้ผู้อ่าน · ปิดใน docs เจ้าของ)

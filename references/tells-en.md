...
> **ที่มาของไฟล์นี้ต่างจาก `tells-th.md`** คลังข้อมูลทั้งสี่ชุดของ klao เป็นภาษาไทยล้วน
> กฎอังกฤษที่เป็น**รายการคำ** จึงเป็น `borrowed` (Wikipedia: Signs of AI writing เป็นหลัก)
> ส่วนกฎที่กลั่นจาก commit/PR ของเจ้าของเองเป็น `คลังข้อมูล` — ระบุไว้รายหมวด

## สิ่งที่ **ไม่ใช่** tell ใน repo พวกนี้ — อย่าไปแก้

> EN-FP · คลังข้อมูล · เทียบจาก commit body เก่าของเจ้าของ — รายการนี้ชนะกฎทุกข้อข้างล่าง
...
> EN-04 · soft · คลังข้อมูล · ข้อ 5–6 (PR body) มาจากวิธีเขียน PR ของเจ้าของเอง
...
> EN-07 · soft · คลังข้อมูล · ยกมาจาก commit จริงของเจ้าของใน repo งานจริง (ไม่ได้อยู่ใน log ของ repo นี้)
